...
Шаблон показывает карточку подписки, блок приложений, раздел помощи, тёмную тему, список конфигов, deeplink-кнопки для добавления подписки и роутинга в Happ, а также поддерживает кастомный заголовок и логотипы.

Быстрый просмотр - https://indie-master.github.io/marzban-subpage/
